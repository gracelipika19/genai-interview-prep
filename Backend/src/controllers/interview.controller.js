...
async function generateInterviewReportController(req, res) {
    try {
        ...
        // Normalize severity values to lowercase to match schema enum
        ...
        console.error("Error inside generateInterviewReportController:", error);
...
/**
 * @description Controller to get inerview report bu interviewId 
 */
